...
function [iFC_all,Leading_Eig] = leida_emp_trio165(cell_hc_ad,flp,fhi,n,TR)%14*2(90*230double)
...
[n_Subjects, n_cond]=size(tc_aal_new);%165*1
[N_areas, Tmax]=size(tc_aal_new{1,1});%90*170

% Parameters of the data
%TR=0.8;  % Repetition Time (seconds)
% Preallocate variables to save FC patterns and associated information
Leading_Eig=zeros(Tmax*n_Subjects,1*N_areas); % All leading eigenvectors;(170*165,90)
Time_all=zeros(1, n_Subjects*Tmax); % vector with subject nr and cond at each t
