...
function [iFC_all,Leading_Eig] = leida_emp_trio(cell_hc_ad,flp,fhi,n)%14*2(90*230double)
...
NSUB_HC = n; % Number of Healthy Control Subjects
NSUB_AD = n; % Number of Alzheimer's Disease Subjects
NSUB_MCI = n;
