...
function [iFC_all,Leading_Eig] = leida_emp_tianjin(cell_hc_ad,flp,fhi)%14*2(90*230double)
...
NSUB_HC = 17; % Number of Healthy Control Subjects
NSUB_AD = 17; % Number of Alzheimer's Disease Subjects
NSUB_MCI = 17;
