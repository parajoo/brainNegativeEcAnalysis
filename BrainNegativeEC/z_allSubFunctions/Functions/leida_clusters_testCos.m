function Clusters = leida_clusters_test2(input,maxk)
...
parfor k=3:maxk  
    ...
    [IDX, C, SUMD, D]=kmeans(X,k,'Distance','cosine','Replicates',50,'Display','final'); %,'Options',opt);   
...
distM_fcd=squareform(pdist(X,'cosine'));
