...
function [iFC_all,Leading_Eig] = leida_emp_bna(cell_hc_ad,flp,fhi)%14*2(90*230double)
...
NSUB_AD = 14; % Number of Alzheimer's Disease Subjects
NSUB_MCI_AD = 14;
...
[n_Subjects, n_cond]=size(tc_aal_new);%14*2
...
Leading_Eig=zeros(Tmax*n_Subjects*3,1*N_areas); % All leading eigenvectors;(230*14,90)
Time_all=zeros(3, n_Subjects*Tmax); % vector with subject nr and cond at each t
iFC_all = zeros(Tmax*n_Subjects*3,N_areas,N_areas);%(230*14,90,90)
