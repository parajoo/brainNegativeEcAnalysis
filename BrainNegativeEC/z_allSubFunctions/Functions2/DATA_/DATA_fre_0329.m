...
for i = 1:length(flp_range)
    for j = 1:length(fhi_range)
        ...
        [iFC_all,Leading_Eig] = leida_emp_trio(cell_global26,flp,fhi);
        ...
        [pms_hc , pms_mci , pms_ad] = cal_pms_trio(cluster.IDX,timepoints,cluster_num);
        centers = cluster.C;
