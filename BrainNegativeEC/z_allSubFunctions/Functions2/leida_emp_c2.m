...
function [iFC_all,Leading_Eig] = leida_emp_c2(cell_hc_ad,flp,fhi)%14*2(90*230double)
...
Leading_Eig=zeros(Tmax*n_Subjects*2,1*N_areas); % All leading eigenvectors;(230*14,90)
%Time_all=zeros(2, n_Subjects*Tmax); % vector with subject nr and cond at each t
iFC_all = zeros(Tmax*n_Subjects*2,N_areas,N_areas);%(230*14,90,90)
