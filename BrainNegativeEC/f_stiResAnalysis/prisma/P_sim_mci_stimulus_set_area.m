...
function P_sim_mci_stimulus_set_area(set_area,name)
...
%% initialize parameters for iteration
   ...
   % while iter < 2
    ...
    min_pms_G = results(min_index).pms_mci_sim;
    best_G_kld = stimulus(min_index);
    ...
    best_G_diff = stimulus(max_index);
