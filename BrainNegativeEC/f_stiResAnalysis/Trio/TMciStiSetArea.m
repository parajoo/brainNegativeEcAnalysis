    ...
    function TMciStiSetArea(set_area,name)
    ...
    load ('mci848_data.mat','mci847_ec')
    SC1 =mci847_ec;
    ...
    for ii = 1:length(stimulus)
        ...
        results(ii).pms_ad_sim = pms_mci_sim;
...
%%  save data
cd /home/zengmin/model/pms_tianjin_data/trio_scale_622/trioResCity_Sti0718/MCI/
