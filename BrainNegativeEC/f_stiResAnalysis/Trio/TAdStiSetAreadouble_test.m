    ...
    function TAdStiSetAreadouble_test(set_area1,set_area2,name)
    ...
    % area1
    %stimulus1 =0.04;
    stimulus1 = -0.01:0.001:0.01;
    sti_areas1 = zeros(N,1);
    idx_area1 = set_area1;
    sti_areas1(idx_area1) = 1;
    % area2
    %stimulus2 =0.04;
    stimulus2 = -0.01:0.001:0.01;
    ...
    for ii = 1:length(stimulus_all)
       % for ii = 2:2
        ...
        parfor tr = 1:nTrials %并行
            ...
            nn=1;
            y = 0.001*ones(N,1);
            x_all = zeros(round(1000*(Tmax - 1)*TR+1),N);
            y_all = zeros(round(1000*(Tmax - 1)*TR+1),N);
